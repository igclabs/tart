...
/**
 * TART Comprehensive Demo Command
 * 
 * This example demonstrates ALL available TART features in one place.
...
class ComprehensiveDemoCommand extends StyledCommand
{
    /**
    ...
    protected function demoPathHighlighting(): void
    {
        ...
        $paths = [
            ...
            'C:\\Users\\Developer\\Projects\\app\\Http\\Controllers\\UserController.php',
        ];
